...
function Utili(){
    ...
    .then((data) => {
      console.log(data)
      setstNom(data.data.nom)
      settelephone(data.data.telephone)
      setdate(data.data.date_naissance)
      setgroupid(data.data.groupe_id)
    }
  )
    .catch((err) => {
 ...
 .catch(error => console.log(error))
   ...
   useEffect(() => {
    ...
    return(
        ...
        <button className='btn btn-add btn-primary'data-bs-toggle="modal" data-bs-target="#formModal"> <i className="bi bi-plus"></i>Add Stagaire</button>
         {/* MODAL */}
        ...
        <table className='table'>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-header">
                <h5 className="modal-title">Edit Stagaire Name : </h5>
                <button type="button" className="btn-close" data-bs-dismiss="modal"></button>
              </div>
              ...
              <div className="modal-body">
                <form onSubmit={handleEditform}>
                  ...
                  <div className="mb-3">
                    <label className="form-label">Telephone</label>
                    <input type="tel" className="form-control" name='telephone' value={telephone} onChange={(e) => settelephone(e.target.value)} />
                  </div>
                   <div className="mb-3">
                    <label className="form-label">Date Naissance</label>
                    <input type="date" className="form-control" name='date' value={date} onChange={(e) => setdate(e.target.value)}/>
